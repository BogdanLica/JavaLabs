...
/*
    public static void testPart3() {
        ...
        Door doorA = new Door();
        doorA.setRoomName("Research Labs");
        
        CardLock lockA = new CardLock();
        doorA.attachLock(lockA);
        

        SmartCard cardA = new SmartCard("Bogdan Lica");
	System.out.println("* Swiping " + cardA.getOwner() + "'s card");
 	lockA.swipeCard(cardA);
        System.out.println("Is the card lock unlocked? " + lockA.isUnlocked());
        System.out.println();
	System.out.println("Is the door unlocked? ");
	doorA.openDoor();



	SmartCard cardB = new SmartCard("Professor X");
	cardB.setStaff(true);
	System.out.println("* Swiping " + cardB.getOwner() + "'s card");
 	lockA.swipeCard(cardB);
        System.out.println("Is the card lock unlocked? " + lockA.isUnlocked());
        System.out.println();
	System.out.println("Is the door unlocked? ");
	doorA.openDoor();
